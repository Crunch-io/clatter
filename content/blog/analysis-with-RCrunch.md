...
```
    ...
    ## 1  1                                                      NA    NA   FALSE
    ## 2  2                   More than half, but not all, the time     4   FALSE
    ## 3  3 Less than half the time, but at least one day each week     2   FALSE
    ## 4  4                                                   Never     0   FALSE
    ## 5  5       All or almost all the time (I'm full-time remote)     5   FALSE
    ## 6  6                                        It's complicated    NA   FALSE
    ## 7  7                                   A few days each month     1   FALSE
    ## 8  8                                     About half the time     3   FALSE
    ## 9 -1                                                 No Data    NA    TRUE
...
```
    ...
    ##   id                                                    name value missing
    ## 1  4                                                   Never     0   FALSE
    ## 2  7                                   A few days each month     1   FALSE
    ## 3  3 Less than half the time, but at least one day each week     2   FALSE
    ## 4  8                                     About half the time     3   FALSE
    ## 5  2                   More than half, but not all, the time     4   FALSE
    ## 6  5       All or almost all the time (I'm full-time remote)     5   FALSE
...
```
    ...
    ##
    ## Call:
    ## lm(formula = JobSatisfaction ~ HomeRemote, data = so_df)
    ##
    ## Residuals:
    ##     Min      1Q  Median      3Q     Max
    ## -7.3884 -1.0775  0.3675  1.3675  3.3675
    ##
    ## Coefficients:
    ##                                                                   Estimate Std. Error t value Pr(>|t|)
    ## (Intercept)                                                        6.63250    0.01918 345.760  < 2e-16 ***
    ## HomeRemoteA few days each month                                    0.44501    0.02614  17.027  < 2e-16 ***
    ## HomeRemoteLess than half the time, but at least one day each week  0.48762    0.03966  12.294  < 2e-16 ***
    ## HomeRemoteAbout half the time                                      0.34120    0.05910   5.773 7.85e-09 ***
    ## HomeRemoteMore than half, but not all, the time                    0.32068    0.05711   5.616 1.97e-08 ***
    ## HomeRemoteAll or almost all the time (I'm full-time remote)        0.75593    0.03784  19.976  < 2e-16 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ##
    ## Residual standard error: 2.153 on 38585 degrees of freedom
    ##   (12801 observations deleted due to missingness)
    ## Multiple R-squared:  0.01353,    Adjusted R-squared:  0.0134
    ## F-statistic: 105.8 on 5 and 38585 DF,  p-value: < 2.2e-16
